...
int main()
{
	...
	Shader lampShader("lightShader.vert", "lightShader.frag");
	...
	glUniform1i(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0); // We set a location of the texture for the Sampler to pull from.
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		GLint lampColor = glGetUniformLocation(lampShader.Program, "lightColor");
